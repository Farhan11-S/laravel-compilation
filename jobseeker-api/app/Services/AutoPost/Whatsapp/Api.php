...
namespace App\Services\AutoPost\Whatsapp;
...
class Api
{
     ...
     * Message Channel
     * 
     * Send new text, to a Channel using an ID.
     * 
     * */
    public static function messageChannel(string $group, string $message, $priority = null)
    {
