...
namespace App\Services\AutoPost\Telegram;
...
class Api
{
     ...
     * @return bool|mixed
     */
    public static function sendMessage($text, $inline_keyboard = '', $reply_keyboard = '', $parse_mode = 'HTML', $disable_web_page_preview = false, $disable_notification = false, $reply_to_message_id = '', $chat_id = null)
    {
        self::initialize();
     ...
     * @return bool|mixed
     */
    public static function sendPhoto($photo, $caption = '', $inline_keyboard = '', $reply_keyboard = '', $disable_notification = false, $reply_to_message_id = '', $chat_id = null)
    {
        self::initialize();
        $chat_id = $chat_id ? $chat_id : self::$channel_username;
     ...
     * @return bool|mixed
     */
    public static function sendAudio($audio, $caption = '', $duration = '', $performer = '', $title = '', $inline_keyboard = '', $reply_keyboard = '', $disable_notification = false, $reply_to_message_id = '', $chat_id = null)
    {
        self::initialize();
        $chat_id = $chat_id ? $chat_id : self::$channel_username;
     ...
     * @return bool|mixed
     */
    public static function sendDocument($document, $caption = '', $inline_keyboard = '', $reply_keyboard = '', $disable_notification = false, $reply_to_message_id = '', $chat_id = null)
    {
        self::initialize();
        $chat_id = $chat_id ? $chat_id : self::$channel_username;
     ...
     * @return bool|mixed
     */
    public static function sendVideo($video, $duration = '', $width = '', $height = '', $caption = '', $inline_keyboard = '', $reply_keyboard = '', $disable_notification = false, $reply_to_message_id = '', $chat_id = null)
    {
        self::initialize();
        $chat_id = $chat_id ? $chat_id : self::$channel_username;
     ...
     * @return bool|mixed
     */
    public static function sendVoice($voice, $caption = '', $duration = '', $inline_keyboard = '', $reply_keyboard = '', $disable_notification = false, $reply_to_message_id = '', $chat_id = null)
    {
        self::initialize();
        $chat_id = $chat_id ? $chat_id : self::$channel_username;
     ...
     * @return bool|mixed
     */
    public static function sendMediaGroup($media, $disable_notification = false, $reply_to_message_id = '', $chat_id = null)
    {
        self::initialize();
        $chat_id = $chat_id ? $chat_id : self::$channel_username;
     ...
     * @return bool|mixed
     */
    public static function sendLocation($latitude, $longitude, $live_period = '', $inline_keyboard = '', $reply_keyboard = '', $disable_notification = false, $reply_to_message_id = '', $chat_id = null)
    {
        self::initialize();
        $chat_id = $chat_id ? $chat_id : self::$channel_username;
     ...
     * @return bool|mixed
     */
    public static function sendVenue($latitude, $longitude, $title, $address, $foursquare_id = '', $inline_keyboard = '', $reply_keyboard = '', $disable_notification = false, $reply_to_message_id = '', $chat_id = null)
    {
        self::initialize();
        $chat_id = $chat_id ? $chat_id : self::$channel_username;
     ...
     * @return bool|mixed
     */
    public static function sendContact($phone_number, $first_name, $last_name, $inline_keyboard = '', $reply_keyboard = '', $disable_notification = false, $reply_to_message_id = '', $chat_id = null)
    {
        self::initialize();
        $chat_id = $chat_id ? $chat_id : self::$channel_username;
    ...
    {
        $method2 = $method ?? 'sendMessage';
        $curl = curl_init(self::$api_url . self::$api_token . '/' . $method2);
